...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net fifo_ethernet_rx_M_AXIS [get_bd_intf_pins fifo_ethernet_rx/M_AXIS] [get_bd_intf_pins mii_mac_0/tx_saxis]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets processing_system7_0_GPIO_0] [get_bd_intf_ports GPIO_0_0] [get_bd_intf_pins system_ila_0/SLOT_0_GPIO]
  ...
  connect_bd_net -net mii_mac_0_tx_mii_d [get_bd_ports enet0_gmii_txd] [get_bd_pins mii_mac_0/tx_mii_d]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets mii_mac_0_tx_mii_d]
  connect_bd_net -net mii_mac_0_tx_mii_en [get_bd_ports ENET0_GMII_TX_EN_0] [get_bd_pins mii_mac_0/tx_mii_en]
  ...
  connect_bd_net -net tri_mode_ethernet_mac_0_tx_mac_aclk [get_bd_ports ENET0_GMII_TX_CLK_0] [get_bd_pins fifo_ethernet_rx/m_axis_aclk] [get_bd_pins mii_mac_0/tx_clock] [get_bd_pins proc_sys_reset_tx/slowest_sync_clk]
